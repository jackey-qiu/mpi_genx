...
class Plugin(Template):
    ...
    def LoadData(self, data_item_number, filename):
        ...
        try:
            ...
            if load_array.shape[1]-1 < max(self.E_col,self.h_col, self.k_col,\
            ...
            data = np.rec.fromarrays([\
                     ...
                     names = 'E, h, k, l, I, eI, LB, dL')
            # Sort the data
            data.sort(order = ('h','k','E'))
            i = 0
            while i < len(data):
                ...
                self.data[-1].set_extra_data('l', tmp['l'], 'l')
    ...
    def SettingsDialog(self):
        ...
        col_values = {'I': self.I_col,'h': self.h_col,'k': self.k_col,\
                        ...
                        'LB': self.LB_col,'dL': self.dL_col,'E': self.E_col}
